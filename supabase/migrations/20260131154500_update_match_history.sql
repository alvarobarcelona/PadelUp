DROP FUNCTION IF EXISTS get_player_match_history(uuid, integer);

CREATE OR REPLACE FUNCTION get_player_match_history(id_input uuid, limit_count integer DEFAULT 10)
RETURNS TABLE(
    id bigint, 
...
BEGIN
  ...
  rejected AS (
    SELECT DISTINCT ON (id)
      ...
      al.created_at,
      NULL::uuid as created_by, -- Added to match column count
